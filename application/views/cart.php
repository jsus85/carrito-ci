                         ...
                         <?php 
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <div class="d-flex">
                                            <img height="100" src="<?php echo base_url();?>uploads/<?php echo $item["image"]; ?>" alt="">
                                        </div>
                                ...
                                <td>
                                    <h5><?php echo 'S/.'.$item["price"].' Soles'; ?></h5>
                                </td>
                                <td>
                                    <div class="product_count">
                                        <input type="text" value="<?php echo $item["qty"]; ?>" onchange="updateCartItem(this, '<?php echo $item["rowid"]; ?>')" name="qty" id="sst" maxlength="12" value="1" title="Quantity:" class="input-text qty" />
                                    </div>
                                </td>
                                <td>
                                    <h5><?php echo 'S/.'.$item["subtotal"].' Soles'; ?></h5>
                                    <a href="<?php echo base_url('cart/removeItem/'.$item["rowid"]); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')"><i class="ti-trash"></i></a>
                                </td>
                            </tr>
                           <?php 
                                }
                           ...
                           ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h5><?php echo 'S/.'.$this->cart->total().' Soles'; ?></h5>
                                </td>
                            </tr>
