				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="<?php echo base_url();?>uploads/<?php echo $value->imagen;?>" alt="">
							<div class="product-details">
								<h6><?php echo $value->nombres;?></h6>
								<div class="price">
									<h6>S/. <?php echo $value->precio;?></h6>
									<h6 class="l-through">$210.00</h6>
								</div>
								<div class="prd-bottom">

									<a href="<?php echo base_url('product/addToCart/'.$value->id); ?>" class="social-info">
